...
function draw(){
  ...
  pop();
   ...
   push();
  r=(a*(1-(e*e)))/(1+e*cos(theta))*scalef
  x=r*cos(theta)
  y=r*sin(theta)
  translate(300,300);
  fill(225);
  ...
  push();
  r1=(a1*(1-(e1*e1)))/(1+e1*cos(theta1))*scalef
  x1=r1*cos(theta1)
  y1=r1*sin(theta1)
  translate(300,300);
  fill(225);
  ...
  push();
  r2=(a2*(1-(e2*e2)))/(1+e2*cos(theta2))*scalef
  x2=r2*cos(theta2)
  y2=r2*sin(theta2)
  translate(300,300);
  fill(225);
  ...
  textStyle(BOLD);
  textSize(18);
  text('Ganymede', x2+5, y2-5);
  pop();
 
  push();
  r3=(a3*(1-(e3*e3)))/(1+e3*cos(theta3))*scalef
  x3=r3*cos(theta3)
  y3=r3*sin(theta3)
  translate(300,300);
  fill(225);
